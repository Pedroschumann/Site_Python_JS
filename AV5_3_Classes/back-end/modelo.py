...
class Anime(db.Model):
    ...
    def __str__(self):
        return self.nome + ", " + self.genero + ", " + self.num_de_ep + ", " + self.estudio.nome
    ...
    def json(self):
        return {
            ...
            "nome": self.nome,
            "gênero": self.genero,
            "numero de episódios": self.num_de_ep,
            "nome do estúdio": self.estudio.nome
        }
...
# Teste da classe Estudio
    e1 = Estudio(fundacao="28/05/1998", nome="Mashiro SB")
