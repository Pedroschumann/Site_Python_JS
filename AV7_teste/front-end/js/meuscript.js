$(function() { // quando o documento estiver pronto/carregado
    var urlX = 'http://PedroSchumann.pythonanywhere.com/'
...
// ================================================================= ESTUDIO =======================================================================
    ...
    function exibir_estudio() {
        ...
        $.ajax({
            url: urlX + '/listar_estudio',
            method: 'GET',
            dataType: 'json', // os dados são recebidos no formato json
            success: listar, // chama a função listar para processar o resultado
            error: function(problema) {
                alert("erro ao ler dados, verifique o backend 1: ");
            }
        });
    ...
    $(document).on("click", ".excluir_estudio", function() {
        ...
        $.ajax({
            url: urlX + 'excluir_estudio/'+id_estudio,
...
//================================================================== PERSONAGEM ==================================================================
    ...
    function exibir_personagem() {
        ...
        $.ajax({
            url: urlX + '/listar_personagem',
            method: 'GET',
            dataType: 'json', // os dados são recebidos no formato json
            success: listar, // chama a função listar para processar o resultado
            error: function(problema) {
                alert("erro ao ler dados, verifique o backend 2: ");
            }
        });
    ...
    function carregarCombo(combo_id, nome_classe) {
        $.ajax({
            ...
            error: function(problema) {
                alert("erro ao ler dados, verifique o backend 3: ");
            }
        });
    ...
    $('#modalIncluirPersonagem').on('shown.bs.modal', function (e) {
        // carregar as listas de animes 
        carregarCombo("campoAnimeId", "Anime");
    })
    ...
    $(document).on("click", "#btIncluirPersonagem", function() {
        ...
        anime_id = $("#campoAnimeId").val();

        // preparar dados no formato json
        var dados = JSON.stringify({ nome: nome, funcao: funcao, caracteristicas: caracteristicas, anime_id: anime_id });
        // fazer requisição para o back-end
        $.ajax({
            url: urlX + '/incluir_personagem',
            type: 'POST',
            dataType: 'json', // os dados são recebidos no formato json
            contentType: 'application/json', // tipo dos dados enviados
            data: dados, // estes são os dados enviados
    ...
    $('#modalIncluirPersonagem').on('hide.bs.modal', function (e) {
        // se a página de listagem não estiver invisível
        if (! $("#cadastroPersonagem").hasClass('d-none')) {
            // atualizar a página de listagem
            exibir_personagem();
        }
    });
    ...
    $(document).on("click", ".excluir_personagem", function() {
        ...
        // solicitar a exclusão da anime
        $.ajax({
            url: urlX + '/excluir_personagem/'+id_personagem,
            type: 'DELETE', // método da requisição
            dataType: 'json', // os dados são recebidos no formato json
...
//================================================================== ANIME ==================================================================
    ...
    function exibir_anime() {
        $.ajax({
            url: urlX + '/listar_anime',
            method: 'GET',
            dataType: 'json', // os dados são recebidos no formato json
            success: listar, // chama a função listar para processar o resultado
            error: function(problema) {
                alert("erro ao ler dados, verifique o backend 4: ");
            }
        });
    ...
    $('#modalIncluirAnime').on('shown.bs.modal', function (e) {
        // carregar as listas de estudios
        carregarCombo("campoEstudioId", "Estudio");
    })
    ...
    $(document).on("click", "#btIncluirAnime", function() {
        ...
        estudio_id = $("#campoEstudioId").val();

        // preparar dados no formato json
        var dados = JSON.stringify({ nome: nome, genero: genero, num_de_ep: num_de_ep, estudio_id: estudio_id});
        // fazer requisição para o back-end
        $.ajax({
            url: urlX + '/incluir_anime',
            type: 'POST',
            dataType: 'json', // os dados são recebidos no formato json
            contentType: 'application/json', // tipo dos dados enviados
            data: dados, // estes são os dados enviados
    ...
    $('#modalIncluirAnime').on('hide.bs.modal', function (e) {
        // se a página de listagem não estiver invisível
        if (! $("#cadastroAnime").hasClass('d-none')) {
            // atualizar a página de listagem
            exibir_anime();
        }
    });
    ...
    $(document).on("click", ".excluir_anime", function() {
        ...
        // solicitar a exclusão da anime
        $.ajax({
            url: urlX + 'excluir_anime/'+id_anime,
            type: 'DELETE', // método da requisição
            dataType: 'json', // os dados são recebidos no formato json
